...
const Service = () => {
    return (
        <Layout
            title="Expert Web Design & Development Services | Texsas Web Solutions"
            description="Discover our comprehensive web services including custom development, responsive design, e-commerce solutions, and SEO optimization. Transform your business with Texsas Web Solutions' professional web services in Texas."
            keywordContent="web design services, website development Texas, e-commerce development, responsive web design, SEO services Texas, web maintenance services, custom web solutions, business website services, professional web agency Texas, web consulting services"
        >
