        ...
        >
            <div className='w-full max-w-screen-xl mx-auto px-3 md:py-24'>
                <div className='flex flex-col-reverse md:flex-row justify-between'>
                    ...
                    <img className=' md:w-[40%] rounded-3xl object-cover shadow-2xl border border-4 ' src='./images/aboutimage.jpg' alt='Leading Web Design & Development Company – Your Trusted Digital Agency' />
                </div>
                ...
                <div className='flex flex-col-reverse md:flex-row-reverse justify-between '>
                    ...
                    <img className='md:w-[40%] w-full rounded-3xl object-cover shadow-2xl border border-4 ' src='./images/about2.jpg' alt='Leading Web Design & Development Company – Your Trusted Digital Agency' />
                </div>
