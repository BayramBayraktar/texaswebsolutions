                ...
                <div className='text-white flex md:flex-row flex-col gap-8 h-full md:h-screen'>
                    <div className='md:w-1/3 w-full flex flex-col gap-8 h-full'>
                        <div className='md:h-2/3 h-full p-6 bg-[rgba(126,214,223,.15)] rounded-3xl border gap-y-2 flex flex-col justify-between'>
                            <p className=''>"Working with this Texas-based web agency was a game-changer for my small business. They delivered a stunning website that truly represents my brand and has increased customer engagement dramatically!"</p>
                            <div className='flex items-center gap-4'>
                                <img className='max-w-8 ' src='./images/customer1.avif' alt='' />
                                <div>
                        ...
                        <div className='md:h-1/3 h-full p-6 bg-[rgba(126,214,223,.15)] rounded-3xl border gap-y-2 flex flex-col justify-between'>
                            <p className=''>"Their expertise in SEO and social media integration helped us gain more visibility online. Now, we're attracting more customers than ever before!"</p>
                            <div className='flex items-center gap-4'>
                                <img className='max-w-8 ' src='./images/customer2.avif' alt='' />
                                <div>
                    ...
                    <div className='md:w-1/3 w-full flex flex-col gap-8 h-full'>
                        <div className='h-1/3 p-6 bg-[rgba(126,214,223,.15)] rounded-3xl border gap-y-2 flex flex-col justify-between'>
                            <p className=''>"The provided outstanding support and design expertise. Our website now looks professional and is easy to navigate."</p>
                            <div className='flex items-center gap-4'>
                                <img className='max-w-8 ' src='./images/customer3.avif' alt='' />
                                <div>
                        ...
                        <div className='h-2/3 p-6 bg-[rgba(126,214,223,.15)] rounded-3xl border gap-y-2 flex flex-col justify-between'>
                            <p className=''>"Our sales increased after launching our new website. The professional design and SEO improvements really made a difference!"</p>
                            <div className='flex items-center gap-4'>
                                <img className='max-w-8 ' src='./images/customer4.avif' alt='' />
                                <div>
                    ...
                    <div className='md:w-1/3 w-full flex flex-col gap-8 h-full'>
                        <div className='h-2/3 p-6 bg-[rgba(126,214,223,.15)] rounded-3xl border gap-y-2 flex flex-col justify-between'>
                            <p className=''>"Our renovation business skyrocketed after this website! 💻 Client inquiries tripled, and the online booking system cut our scheduling chaos by half. Finally, a site that actually works for contractors!"</p>
                            <div className='flex items-center gap-4'>
                                <img className='max-w-8 ' src='./images/manger.avif' alt='' />
                                <div>
                        ...
                        <div className='h-1/3 p-6 bg-[rgba(126,214,223,.15)] rounded-3xl border gap-y-2 flex flex-col justify-between'>
                            <p className=''>"The SEO service brought us 50% more bathroom remodel requests! 🚽 Now I spend less time marketing and more time doing what I love – transforming homes."</p>
                            <div className='flex items-center gap-4'>
                                <img className='max-w-8 ' src='./images/manger.avif' alt='' />
                                <div>
